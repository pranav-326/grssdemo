...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 grid-bg-overlay z-10 pointer-events-none opacity-30" />

      {/* ================= GROUND TARGET RETICLE OVERLAY ================= */}
      <TargetReticle opacity={Math.max(0, (scrollProgress - 0.7) / 0.3)} />

      {/* ================= SERIAL CONTENT NARRATIVE TRACK ================= */}
      <div className="relative z-20 w-full max-w-4xl mx-auto px-4 py-16 space-y-28 md:space-y-36">
        ...
        <section className="min-h-screen flex flex-col justify-center items-center text-center space-y-6 pt-12">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-space-900/90 border border-ndvi-neon/40 shadow-neon-green backdrop-blur-md">
          ...
          <div className="max-w-2xl bg-space-950/80 backdrop-blur-md p-6 rounded-2xl border border-white/10 space-y-4 text-slate-200 text-sm md:text-base leading-relaxed text-center shadow-hud-card">
            <p>
            ...
            <div className="pt-2 text-xs md:text-sm font-mono font-bold text-white border-t border-white/10">
          ...
          <div className="pt-8 flex flex-col items-center gap-2 text-ndvi-neon animate-pulse">
        ...
        <section className="space-y-8">
          ...
          {/* About NIE */}
          <div className="bg-space-950/85 backdrop-blur-md p-6 sm:p-8 rounded-2xl border border-ndvi-neon/30 corner-bracket shadow-hud-card space-y-3">
            <div className="flex items-center gap-2 text-xs font-mono text-ndvi-neon font-bold uppercase tracking-wider">
          ...
          {/* About NISB-GRSS */}
          <div className="bg-space-950/85 backdrop-blur-md p-6 sm:p-8 rounded-2xl border border-radar-cyan/30 corner-bracket shadow-hud-card space-y-3">
            <div className="flex items-center gap-2 text-xs font-mono text-radar-cyan font-bold uppercase tracking-wider">
        ...
        <section className="space-y-6">
          ...
          <div className="text-center space-y-2 bg-space-950/80 backdrop-blur-md p-6 rounded-2xl border border-white/10">
          ...
          <div className="space-y-4">
            ...
            {/* Day 1 */}
            <div className="bg-space-950/85 backdrop-blur-md p-6 rounded-2xl border border-ndvi-neon/30 hover:border-ndvi-neon transition-all space-y-3">
              ...
              <div className="text-xs font-mono text-radar-cyan font-semibold">
              ...
              <div className="pt-2 text-[11px] font-mono italic text-ndvi-bright">
                From observation to insight
              </div>
            </div>

            {/* Day 2 */}
            <div className="bg-space-950/85 backdrop-blur-md p-6 rounded-2xl border border-radar-cyan/30 hover:border-radar-cyan transition-all space-y-3">
              <div className="flex items-center justify-between border-b border-white/10 pb-2">
              ...
              <div className="pt-2 text-[11px] font-mono italic text-radar-cyan">
                From insight to intelligence
              </div>
            </div>

            {/* Day 3 */}
            <div className="bg-space-950/85 backdrop-blur-md p-6 rounded-2xl border border-radar-amber/30 hover:border-radar-amber transition-all space-y-3">
              <div className="flex items-center justify-between border-b border-white/10 pb-2">
              ...
              <div className="pt-2 text-[11px] font-mono italic text-radar-amber">
        ...
        {/* ----------------------------------------------------------------- */}
        <section className="bg-space-950/85 backdrop-blur-md p-6 sm:p-8 rounded-2xl border border-ndvi-neon/30 space-y-4">
          ...
          <div className="pt-2 text-xs font-mono text-radar-cyan font-semibold italic">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-space-950/80 backdrop-blur-md p-6 rounded-2xl border border-slate-800 space-y-2">
        ...
        {/* ----------------------------------------------------------------- */}
        <section className="bg-space-950/90 backdrop-blur-2xl border-2 border-ndvi-neon rounded-3xl p-6 sm:p-10 shadow-neon-green space-y-6 text-center">
          ...
          <div className="max-w-xl mx-auto space-y-2 text-xs sm:text-sm font-mono text-slate-300">
          ...
          <div className="pt-2 text-sm sm:text-base font-display font-bold text-white tracking-wider text-glow-green">
        ...
        {/* Footer */}
        <footer className="pt-8 pb-16 text-center text-xs font-mono text-slate-400 space-y-2 border-t border-white/10">
