    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-3 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex flex-col text-center md:text-left">
            <span className="text-xl sm:text-2xl md:text-3xl font-heading font-bold text-vanilla tracking-tightest leading-none">
              GRSS School
            </span>
            <span className="text-[10px] sm:text-xs md:text-sm font-subheading font-bold text-tea tracking-tight leading-tight pt-1 max-w-lg">
          ...
          <div className="flex items-center justify-center flex-wrap gap-3 sm:gap-4 md:gap-6">
            ...
            <a
              ...
              className="ml-2 px-4 py-2.5 rounded-lg bg-olive text-earth-950 font-subheading font-bold text-xs sm:text-sm tracking-tight shadow-earth-card hover:bg-tea transition-all flex items-center gap-1.5 no-underline"
            >
              <span>Register</span>
      ...
      >
        ...
        >
          ...
          <span className="text-xs font-subheading font-bold tracking-tight uppercase text-tea group-hover:text-vanilla">
            Menu
          </span>
        </button>
        ...
        {isMenuOpen && (
          <div className="absolute right-0 mt-3 w-72 sm:w-80 rounded-2xl bg-black/95 border border-copper/35 backdrop-blur-xl p-5 shadow-2xl space-y-4 animate-in fade-in slide-in-from-top-2 duration-200">
            <div className="flex items-center justify-between border-b border-copper/25 pb-3">
              <div>
                <div className="font-heading font-bold text-sm text-vanilla tracking-tight">GRSS School</div>
                <div className="text-[10px] font-subheading font-bold text-tea tracking-tight">GeoIntelligence in Agriculture</div>
              </div>
              <button
            ...
            <div className="pt-2 border-t border-copper/20">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full py-2.5 px-4 rounded-xl bg-olive text-earth-950 font-subheading font-bold text-xs tracking-tight shadow-earth-card hover:bg-tea transition-all flex items-center justify-center gap-2 no-underline"
              >
      ...
      <div suppressHydrationWarning className="relative z-20 w-full max-w-4xl mx-auto px-6 py-20 space-y-36 md:space-y-48">
        ...
        <section suppressHydrationWarning className="min-h-screen flex flex-col justify-center items-center text-center space-y-6 pt-28 sm:pt-36 md:pt-40">
          ...
          <div suppressHydrationWarning className="w-full max-w-3xl bg-black/85 backdrop-blur-md border border-copper/30 rounded-3xl p-6 sm:p-10 md:p-12 shadow-2xl space-y-7 text-center">
            ...
            <div className="space-y-1.5 pt-1">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-heading font-bold text-vanilla tracking-tightest">
                GRSS School
              </h1>
              <p className="text-sm sm:text-base md:text-lg font-subheading font-bold text-tea tracking-tight max-w-xl mx-auto">
                on GeoIntelligence for Sustainable Precision Agriculture
              </p>
            </div>
            ...
            {/* Narrative Theme Hook with Left-to-Right Narration Typing (Quote: Playfair Display Italics) */}
            <div className="text-2xl sm:text-3xl md:text-4xl font-quote italic font-normal text-vanilla leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)] tracking-tight">
              <NarrationTyping text="From the world above us," delay={200} speed={36} />
              <br />
              <span className="italic text-tea font-normal">
            ...
            <div suppressHydrationWarning className="max-w-2xl mx-auto text-center space-y-5 text-vanilla/95 text-base md:text-lg leading-relaxed font-sans font-normal tracking-tight">
              <NarrationLine delay={200}>
                <p>
                  <strong className="text-vanilla font-quote italic text-xl block mb-2 tracking-tight">
              ...
              <NarrationLine delay={350}>
                <p className="text-sm md:text-base text-tea/95 leading-relaxed font-sans font-normal tracking-tight">
                  From acquiring data about the Earth to understanding crops and soil and finally using intelligence to manage water and irrigation, this event takes you from <span className="text-vanilla font-subheading font-bold underline decoration-copper/50 underline-offset-4">observation to insight</span> and from <span className="text-vanilla font-subheading font-bold underline decoration-olive/60 underline-offset-4">insight to action</span>.
                </p>
              </NarrationLine>
              
              <NarrationLine delay={500}>
                <div suppressHydrationWarning className="pt-4 text-sm md:text-base font-quote italic text-tea border-t border-copper/20 tracking-tight">
                  Three days. One planet. A world of data waiting to be explored.
                </div>
              </NarrationLine>
            </div>

            <p className="text-xs md:text-sm font-quote italic text-copper max-w-lg mx-auto pt-2 tracking-tight">
              <NarrationWords
          ...
          <div suppressHydrationWarning className="pt-4 flex flex-col items-center gap-2">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-black/75 border border-copper/25 backdrop-blur-sm shadow-sm">
              <span className="text-[11px] font-subheading font-bold text-tea tracking-tight uppercase">
                Scroll to Descend
              </span>
        ...
        <section id="about" suppressHydrationWarning className="space-y-12 scroll-mt-24">
          ...
          <div suppressHydrationWarning className="bg-earth-900/60 backdrop-blur-md p-8 sm:p-10 rounded-2xl border border-copper/25 shadow-earth-card space-y-4 text-left">
            ...
            <h2 className="text-2xl sm:text-3xl font-heading font-bold text-vanilla tracking-tight">
              <NarrationTyping text="The National Institute of Engineering" delay={150} speed={25} />
            </h2>
            <div className="copper-rule w-24 my-2" />
            <p className="text-sm md:text-base text-vanilla/90 leading-relaxed font-sans font-normal tracking-tight">
              Established in <strong className="text-tea font-subheading font-bold">1946</strong>, <strong className="text-vanilla font-subheading font-bold">NIE</strong> has grown into one of India&apos;s leading engineering institutions, building a legacy of education, innovation, and technological excellence, <span className="text-tea">and today, that journey extends far beyond the campus</span>, beyond the horizon, and beyond the atmosphere into the systems that allow us to observe our planet itself.
            </p>
          </div>
          ...
          <div suppressHydrationWarning className="bg-earth-900/60 backdrop-blur-md p-8 sm:p-10 rounded-2xl border border-copper/25 shadow-earth-card space-y-4 text-left">
            ...
            <div className="copper-rule w-24 my-2" />
            <p className="text-sm md:text-base text-vanilla/90 leading-relaxed font-sans font-normal tracking-tight">
              At the heart of this journey is the <strong className="text-vanilla font-subheading font-bold">NIE IEEE Student Branch — GRSS</strong>, bringing the world of geoscience and remote sensing closer to students.
            </p>
            <p className="text-sm md:text-base text-tea/90 leading-relaxed font-sans font-normal tracking-tight">
              Backed by <strong className="text-vanilla font-subheading font-bold">IEEE</strong>, <strong className="text-vanilla font-subheading font-bold">GRSS</strong> brings together a global community exploring Earth through <span className="text-vanilla font-subheading font-bold">remote sensing, geospatial technologies, and Earth observation</span> to NIE, and that global vision takes shape through the <span className="text-tea font-subheading font-bold">NISB–GRSS Chapter</span>, connecting students to the world of geoscience and remote sensing through technical learning, expert interactions, and hands-on experiences, and now, this chapter brings that global perspective to you.
            </p>
          </div>
        ...
        <section id="schedule" suppressHydrationWarning className="space-y-10 scroll-mt-24">
          ...
          <div suppressHydrationWarning className="text-center space-y-3">
            <span className="text-xs font-subheading font-bold text-tea tracking-tight uppercase">
              Event Itinerary
            </span>
            <h2 className="text-3xl sm:text-4xl font-heading font-bold text-vanilla tracking-tight">
              <NarrationTyping text="The Schedule" delay={100} speed={35} />
            </h2>
            <p className="text-base font-quote italic text-tea/90 tracking-tight">
              <NarrationWords text="Three Days. Three Perspectives. Three Leaps." staggerMs={28} delay={200} />
            </p>
            <p className="text-xs sm:text-sm text-copper font-sans font-normal max-w-lg mx-auto tracking-tight">
              <NarrationWords
          ...
          <div suppressHydrationWarning className="space-y-6">
            ...
            <div suppressHydrationWarning className="bg-earth-900/50 backdrop-blur-md p-8 rounded-2xl border border-copper/25 shadow-earth-card space-y-4 text-left transition-all hover:border-olive/40">
              <div suppressHydrationWarning className="flex items-center justify-between border-b border-copper/20 pb-3">
                <span className="text-xs font-subheading font-bold text-tea uppercase tracking-tight flex items-center gap-2">
                  <Calendar className="w-3.5 h-3.5 text-olive" />
                  Day 01 · November 3
                </span>
                <span className="text-[10px] font-subheading font-bold text-copper uppercase tracking-tight">
                  Stage I: Observation
                </span>
              </div>
              <h3 className="text-xl sm:text-2xl font-heading font-bold text-vanilla tracking-tight">
                <NarrationTyping text="See the Earth Differently" delay={100} speed={25} />
              </h3>
              <div suppressHydrationWarning className="text-xs font-subheading font-bold text-tea tracking-tight">
                <NarrationWords text="Geospatial Data Acquisition & Earth Observation" delay={200} staggerMs={20} />
              </div>
              <p className="text-sm text-vanilla/90 leading-relaxed font-sans font-normal tracking-tight">
                Begin with <strong className="text-vanilla font-subheading font-bold">Geo-AI for Precision Agriculture</strong>, bringing together satellite, UAV, and field-based observations.
              </p>
              <p className="text-sm text-vanilla/90 leading-relaxed font-sans font-normal tracking-tight">
                Then get hands-on with <strong className="text-vanilla font-subheading font-bold">Google Earth Engine and UAV data</strong> to map agricultural fields and monitor crops.
              </p>
              <div suppressHydrationWarning className="pt-2 text-xs font-quote italic text-copper border-t border-copper/15 tracking-tight">
            ...
            <div suppressHydrationWarning className="bg-earth-900/50 backdrop-blur-md p-8 rounded-2xl border border-copper/25 shadow-earth-card space-y-4 text-left transition-all hover:border-olive/40">
              ...
              <p className="text-sm text-vanilla/90 leading-relaxed font-sans font-normal tracking-tight">
                Go deeper with <strong className="text-vanilla font-subheading font-bold">machine learning and deep learning</strong> for crop classification and agricultural monitoring.
              </p>
              <p className="text-sm text-vanilla/90 leading-relaxed font-sans font-normal tracking-tight">
                Explore how Geo-AI can reveal <strong className="text-vanilla font-subheading font-bold">crop health, soil moisture, and vegetation stress</strong>—then apply it yourself using satellite and UAV data.
              </p>
              <div suppressHydrationWarning className="pt-2 text-xs font-quote italic text-copper border-t border-copper/15 tracking-tight">
            ...
            <div suppressHydrationWarning className="bg-earth-900/50 backdrop-blur-md p-8 rounded-2xl border border-copper/25 shadow-earth-card space-y-4 text-left transition-all hover:border-olive/40">
              ...
              <p className="text-sm text-vanilla/90 leading-relaxed font-sans font-normal tracking-tight">
                Explore AI-driven approaches to <strong className="text-vanilla font-subheading font-bold">agricultural drought, crop water stress, and irrigation management.</strong>
              </p>
              <p className="text-sm text-vanilla/90 leading-relaxed font-sans font-normal tracking-tight">
                Bring it all together by developing a <strong className="text-vanilla font-subheading font-bold">Geo-AI-based Precision Irrigation Decision-Support System.</strong>
              </p>
              <div suppressHydrationWarning className="pt-2 text-xs font-quote italic text-copper border-t border-copper/15 tracking-tight">
        ...
        <section id="speakers" suppressHydrationWarning className="bg-earth-900/60 backdrop-blur-md p-8 sm:p-10 rounded-2xl border border-copper/25 shadow-earth-card space-y-5 text-left scroll-mt-24">
          <div suppressHydrationWarning className="space-y-2">
            ...
            <p className="text-sm font-quote italic text-tea/90 tracking-tight">
          ...
          <p className="text-sm md:text-base text-vanilla/90 leading-relaxed font-sans font-normal tracking-tight">
            Meet the <strong className="text-vanilla font-subheading font-bold">experts, researchers, and practitioners</strong> bringing their experience in <span className="text-tea font-subheading font-bold">Geoscience, Remote Sensing, Geo-AI, and Precision Agriculture</span> to the event.
          </p>

          <p className="text-sm md:text-base text-tea/90 leading-relaxed font-sans font-normal tracking-tight">
            Through expert talks and hands-on sessions, gain insights from those working at the intersection of <strong className="text-vanilla font-subheading font-bold">technology, data, and our planet. Explore their expertise, discover new perspectives and learn from the people shaping the field.</strong>
          </p>

          <div suppressHydrationWarning className="pt-3 text-xs font-quote italic text-copper border-t border-copper/15 tracking-tight">
            <NarrationWords 
        ...
        <section suppressHydrationWarning className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div suppressHydrationWarning className="bg-earth-900/40 backdrop-blur-md p-8 rounded-2xl border border-copper/20 space-y-3 text-left h-full">
            <h3 className="font-heading font-bold text-vanilla text-lg tracking-tight flex items-center gap-2">
              <CheckCircle2 className="w-4 h-4 text-olive" />
              Event Benefits
            </h3>
            <p className="text-xs sm:text-sm text-tea/80 font-sans font-normal tracking-tight leading-relaxed">
        ...
        <section id="register" suppressHydrationWarning className="bg-earth-900/70 backdrop-blur-md border border-copper/35 rounded-3xl p-8 sm:p-12 shadow-earth-card space-y-8 text-center scroll-mt-24">
          ...
          <div suppressHydrationWarning className="space-y-3">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-vanilla tracking-tight leading-tight">
              <NarrationTyping text="Your view of Earth is about to change." delay={100} speed={30} />
            </h2>
            <div className="copper-rule w-32 mx-auto pt-2" />
          </div>

          <div suppressHydrationWarning className="max-w-xl mx-auto space-y-2 text-sm md:text-base font-sans font-normal text-tea/90 tracking-tight">
            <p>You&apos;ve seen the planet from above.</p>
            <p>You&apos;ve followed the data.</p>
            <p>You&apos;ve explored the technology.</p>
            <div className="pt-2">
              <p className="text-vanilla font-quote italic text-lg tracking-tight">
                <NarrationWords 
          ...
          <p className="text-sm md:text-base text-vanilla/90 font-sans font-normal max-w-lg mx-auto leading-relaxed tracking-tight">
            Join us and explore how <strong className="text-vanilla font-subheading font-bold">satellites, UAVs, geospatial data, and AI</strong> are transforming the way we understand agriculture and our planet.
          </p>

          <div suppressHydrationWarning className="pt-2 text-base sm:text-lg font-quote italic text-tea tracking-tight">
          ...
          <div suppressHydrationWarning className="pt-4 flex justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 rounded-xl bg-olive text-earth-950 font-subheading font-bold text-base tracking-tight shadow-earth-card hover:bg-tea hover:scale-105 active:scale-95 transition-all flex items-center gap-3 no-underline group"
            >
              <span>Register Now</span>
        ...
        {/* Footer */}
        <footer suppressHydrationWarning className="pt-10 pb-16 text-center text-xs font-sans font-normal text-copper space-y-2 border-t border-copper/20 tracking-tight">
